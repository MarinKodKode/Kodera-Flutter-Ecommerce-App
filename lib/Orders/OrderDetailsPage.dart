                    ...
                    ? Container(
                      child: Column(
                        children: [
                          ...
                          Padding(
                              padding: EdgeInsets.all(4.0),
                              child: Text("Token del pedido" + getOrderId),
                          ),
                          Padding(
                            padding: EdgeInsets.all(4.0),
                            child: Text("Pedido el: " + DateFormat("dd MMMM, yyyy - hh:mm aa")
                                .format(DateTime.fromMillisecondsSinceEpoch(int.parse(dataMap["orderTime"]))),
                            style: TextStyle(color: Colors.grey, fontSize: 16.0, fontFamily: "Urbanist"),),
                          ),
                          Divider(height: 2.0,),
...
class StatusBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    status ? msg = "Hecho" : msg = "Algo salió mal...";
...
class ShippingDetails extends StatelessWidget {
          ...
          child: Center(
            child: InkWell(
              ...
              child: Container(
                ...
                height: 50.0,
                child: Center(
                  child: Text("Pedido recibido", style: TextStyle(color: Colors.white, fontSize: 16.0,fontFamily: "Urbanist",),),
                ),
              ),
            ),
          ),
  ...
  confirmUserOrderRecived(BuildContext context, String mOrderId){
    ...
    Fluttertoast.showToast(msg: "¡Producto recibido!");
  }
}
