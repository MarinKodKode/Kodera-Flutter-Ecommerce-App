          ...
          children: [
            Align(
              ...
              child: Padding(
                ...
                child: Text("Selecciona una dirección", style: TextStyle(color: Colors.blue[900],fontWeight: FontWeight.bold,fontSize: 20.0),),
              ),
            ),
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.add_location_alt_outlined, color: Colors.blue[900],),
            Text("Aún no has aladido una dirección"),
            Text("Añade una dirección de envío"),
          ],
        ),
      ),
    );
...
class AddressCard extends StatefulWidget {
  ...
  AddressCard({Key key, this.model, this.addressId, this.totalAmount, this.currentIndex, this.value})
      : super (key: key);
                    ...
                    Container(
                      ...
                      child: Table(
                        children: [
                          ...
                          TableRow(
                              children: [
                                KeyText(msg: "Estado/País",),
                                Text(widget.model.state),
                              ]
                          ),
                          TableRow(
                              children: [
                                KeyText(msg: "Código postal",),
