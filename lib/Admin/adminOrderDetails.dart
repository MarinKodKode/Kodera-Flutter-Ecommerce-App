...
class AdminStatusBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context)
  {
    ...
    status ? msg = "Exitoso" : msg = "Bajo revisión";
...
class AdminShippingDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context)
  {
    ...
    return Column(
      ...
      children: [
        ...
        /*Datalles del cliente que compra*/
        Container(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    "Confirmar envío",
                    style: TextStyle(color: Colors.white, fontSize: 18.0, fontFamily: "urbanist"),
                  ),
                ),
              ),
            ),
  ...
  confirmParcelShifted(BuildContext context, String mOrderId)
  {
    ...
    Fluttertoast.showToast(msg: "Pedido enviado.");
  }
}
